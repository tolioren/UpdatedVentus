...
var AbstractPaginationSubComponent = (function () {
    ...
    AbstractPaginationSubComponent.prototype.ngOnInit = function () {
        ...
        this.service.onChange
            .filter(function (event) { return lang_1.isPresent(event) && lang_1.isPresent(event.name); })
...
var MdPaginationRange = (function (_super) {
    ...
    function MdPaginationRange(service, sanitizationService) {
        ...
        this.rangeFormat = '{start}-{end} of {total}';
        this.value = '';
    }
    ...
    MdPaginationRange.prototype.getRange = function () {
        if (lang_1.isPresent(this.model)) {
    ...
    MdPaginationRange = __decorate([
        ...
        __metadata('design:paramtypes', [pagination_service_1.PaginationService, dom_sanitization_service_1.DomSanitizationService])
    ], MdPaginationRange);
...
var MdPaginationControls = (function (_super) {
    ...
    MdPaginationControls.prototype.isFirstPage = function () {
        return lang_1.isPresent(this.model) && this.model.currentPage == 1;
    };
    MdPaginationControls.prototype.isLastPage = function () {
        return lang_1.isPresent(this.model) && this.model.totalItems <= this.model.currentPage * this.model.itemsPerPage;
    };
...
var MdPaginationItemsPerPage = (function (_super) {
    ...
    Object.defineProperty(MdPaginationItemsPerPage.prototype, "hidden", {
        get: function () { return !this.itemsPerPageOptions || !this.itemsPerPageOptions.length; },
        enumerable: true,
        configurable: true
    });
    ;
