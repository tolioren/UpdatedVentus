...
import { ContentChildren, Directive, EventEmitter, QueryList } from '@angular/core';
 ...
 * ```
 */
let SebmGoogleMapPolyline_1;
export let SebmGoogleMapPolyline = SebmGoogleMapPolyline_1 = class SebmGoogleMapPolyline {
    ...
    ngAfterContentInit() {
        ...
        const s = this._points.changes.subscribe(() => this._polylineManager.updatePolylinePoints(this));
        this._subscriptions.push(s);
    ...
    ngOnChanges(changes) {
        ...
        let options = {};
        const optionKeys = Object.keys(changes).filter(k => SebmGoogleMapPolyline_1._polylineOptionsAttributes.indexOf(k) !== -1);
